...
namespace Register
{
    class Program
    {
        ...
        static void InputtoData() 
        {
           ...
           GetData data = new GetData(name,address,citizenid,number,activity);
        ...
        static void ReturnMenu() 
        {
            ...
            Console.Write("Pleaase Select Menu :");
    ...
    class GetData
    {
        ...
        public GetData(string valuename,string valueaddress,string valueIcitizen,string valuePhonenumber,string valueactivity)
        {
            name = valuename;
            address = valueaddress;
            citizen = valueIcitizen;
    ...
    class AddlistData {
        ...
        public void Showdata() {
            ...
            foreach (GetData show in Addlist) {
                ...
                Console.WriteLine("Citizen:"+show.citizen) ;
